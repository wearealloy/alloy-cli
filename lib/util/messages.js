...
module.exports = function(projectName,messageProjectType) {
  return {
    helloNova: [
      'Thanks for using Alloy CLI for %s!',
      '-------------------------------------------',
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the template " + "Alloy for ".cyan + messageProjectType.cyan +".\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "alloy watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "alloy watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
